...
typedef enum {
	R_ODINTAG_COLLECTION_IMPORTED_INDIRECTLY,
} OdinCollectionRole;
...
static roleDefinition OdinCollectionRoles [] = {
	{ true, "indirectlyImported", "specified when importing a package or ccode" },
};
...
static xtagDefinition OdinXtags [] = {
	{
		...
		.description = "implicitly defined import name like \"printf\" in \"core:fmt/printf\"",
	},
};
